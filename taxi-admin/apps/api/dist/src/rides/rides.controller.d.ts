...
export declare class RidesController {
    ...
    findAll(req: any, filters: FilterRidesDto): Promise<{
        rides: {
            id: string;
            userId: string;
    ...
    create(createRideDto: CreateRideDto, req: any): Promise<{
        id: string;
        userId: string;
        platform: import(".prisma/client").$Enums.PlatformType;
        platformConnectionId: string | null;
    ...
    update(id: string, updateRideDto: UpdateRideDto, req: any): Promise<{
        id: string;
        userId: string;
        platform: import(".prisma/client").$Enums.PlatformType;
        platformConnectionId: string | null;
