...
let RidesService = class RidesService {
    ...
    async findOne(id, userId) {
        ...
        if (!ride) {
            throw new common_1.NotFoundException('Rit niet gevonden');
        }
        return ride;
    }
    async create(userId, createRideDto) {
        ...
        return this.prisma.ride.create({
            data: {
                ...
                vatAmount: vatAmount,
                platform: createRideDto.platform || client_1.PlatformType.manual,
    ...
    async update(id, userId, updateRideDto) {
    ...
    async createManyFromPlatform(userId, platformConnectionId, platform, rides) {
        const created = [];
        const updated = [];
